     ...
     usingSelector:(SEL)selector
{
    ...
    if(self){
        ...
        [contentLabel setFont:VYBE_FONT(15)];
        [contentLabel setTextColor:UIColorFromRGB(WET_ASPHALT, 1)];
                        ...
                        withHFontSizeOffset:(int)hFontOffset
{
    ...
    textField.textColor = UIColorFromRGB(WET_ASPHALT, 1);
...
-(void)drawRect:(CGRect)rect{
    ...
    CGFloat components[8] = {
        0xF4/((float)0xFF), 0xc2/((float)0xFF), 0xc2/((float)0xFF), 1.0,
        0x89/((float)0xFF), 0xcf/((float)0xFF), 0xF0/((float)0xFF), 1.0 };
