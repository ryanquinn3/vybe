...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self)
    {
        ...
        _startRangeLabel.font = VYBE_FONT(10);
        _startRangeLabel.textColor = UIColorFromRGB(MIDNIGHT_BLUE, 1);
        ...
        _endRangeLabel.font = VYBE_FONT(10);
        _endRangeLabel.textColor = UIColorFromRGB(MIDNIGHT_BLUE, 1);
